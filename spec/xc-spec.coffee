...
describe "Language-XC", ->
  ...
  describe "C++", ->
    ...
    it "tokenizes 'extern C'", ->
      ...
      expect(lines[0][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.section.block.begin.bracket.curly.xc']
      expect(lines[1][0]).toEqual value: '#', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.preprocessor.include.xc', 'keyword.control.directive.include.xc', 'punctuation.definition.directive.xc']
      expect(lines[1][1]).toEqual value: 'include', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.preprocessor.include.xc', 'keyword.control.directive.include.xc']
      expect(lines[1][3]).toEqual value: '"', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.preprocessor.include.xc', 'string.quoted.double.include.xc', 'punctuation.definition.string.begin.xc']
      expect(lines[1][4]).toEqual value: 'legacy_C_header.h', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.preprocessor.include.xc', 'string.quoted.double.include.xc']
      expect(lines[1][5]).toEqual value: '"', scopes: ['source.cpp', 'meta.extern-block.cpp', 'meta.preprocessor.include.xc', 'string.quoted.double.include.xc', 'punctuation.definition.string.end.xc']
      expect(lines[2][0]).toEqual value: '}', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.section.block.end.bracket.curly.xc']
      ...
      lines = grammar.tokenizeLines '''
        ...
        #endif
      '''
      expect(lines[0][0]).toEqual value: '#', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc', 'punctuation.definition.directive.xc']
      expect(lines[0][1]).toEqual value: 'ifdef', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc']
      expect(lines[0][3]).toEqual value: '__cplusplus', scopes: ['source.cpp', 'meta.preprocessor.xc', 'entity.name.function.preprocessor.xc']
      ...
      expect(lines[1][6]).toEqual value: '{', scopes: ['source.cpp', 'meta.extern-block.cpp', 'punctuation.section.block.begin.bracket.curly.xc']
      expect(lines[2][0]).toEqual value: '#', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc', 'punctuation.definition.directive.xc']
      expect(lines[2][1]).toEqual value: 'endif', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc']
      ...
      expect(lines[4][0]).toEqual value: '#', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc', 'punctuation.definition.directive.xc']
      expect(lines[4][1]).toEqual value: 'ifdef', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc']
      expect(lines[5][0]).toEqual value: '}', scopes: ['source.cpp']
      expect(lines[6][0]).toEqual value: '#', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc', 'punctuation.definition.directive.xc']
      expect(lines[6][1]).toEqual value: 'endif', scopes: ['source.cpp', 'meta.preprocessor.xc', 'keyword.control.directive.conditional.xc']
    ...
    it "tokenizes UTF string escapes", ->
      ...
      expect(lines[0][1]).toEqual value: '=', scopes: ['source.cpp', 'keyword.operator.assignment.xc']
      ...
      expect(lines[0][12]).toEqual value: ';', scopes: ['source.cpp', 'punctuation.terminator.statement.xc']
    ...
    it "tokenizes % format specifiers", ->
      ...
      expect(tokens[1]).toEqual value: '%d', scopes: ['source.cpp', 'string.quoted.double.cpp', 'constant.other.placeholder.xc']
      expect(tokens[2]).toEqual value: '"', scopes: ['source.cpp', 'string.quoted.double.cpp', 'punctuation.definition.string.end.cpp']

      {tokens} = grammar.tokenizeLine '"%"'
      expect(tokens[0]).toEqual value: '"', scopes: ['source.cpp', 'string.quoted.double.cpp', 'punctuation.definition.string.begin.cpp']
      expect(tokens[1]).toEqual value: '%', scopes: ['source.cpp', 'string.quoted.double.cpp', 'invalid.illegal.placeholder.xc']
      expect(tokens[2]).toEqual value: '"', scopes: ['source.cpp', 'string.quoted.double.cpp', 'punctuation.definition.string.end.cpp']
    ...
    it "tokenizes raw string literals", ->
      ...
      expect(lines[2][1]).toEqual value: ';', scopes: ['source.cpp', 'punctuation.terminator.statement.xc']
    ...
    it "errors on long raw string delimiters", ->
      ...
      expect(lines[0][9]).toEqual value: ';', scopes: ['source.cpp', 'punctuation.terminator.statement.xc']
    ...
    it "tokenizes destructors", ->
      ...
      expect(tokens[1]).toEqual value: '(', scopes: ['source.cpp', 'meta.function.destructor.cpp', 'punctuation.definition.parameters.begin.xc']
      expect(tokens[2]).toEqual value: ')', scopes: ['source.cpp', 'meta.function.destructor.cpp', 'punctuation.definition.parameters.end.xc']
      expect(tokens[4]).toEqual value: '{', scopes: ['source.cpp', 'meta.block.xc', 'punctuation.section.block.begin.bracket.curly.xc']
      expect(tokens[5]).toEqual value: '}', scopes: ['source.cpp', 'meta.block.xc', 'punctuation.section.block.end.bracket.curly.xc']
    ...
    describe "digit separators", ->
      it "recognizes numbers with digit separators", ->
        ...
        expect(tokens[0]).toEqual value: "1'000", scopes: ['source.cpp', 'constant.numeric.xc']

        {tokens} = grammar.tokenizeLine "123'456.500'000e-1'5"
        expect(tokens[0]).toEqual value: "123'456.500'000e-1'5", scopes: ['source.cpp', 'constant.numeric.xc']

        {tokens} = grammar.tokenizeLine "0x1234'5678"
        expect(tokens[0]).toEqual value: "0x1234'5678", scopes: ['source.cpp', 'constant.numeric.xc']

        {tokens} = grammar.tokenizeLine "0'123'456"
        expect(tokens[0]).toEqual value: "0'123'456", scopes: ['source.cpp', 'constant.numeric.xc']

        {tokens} = grammar.tokenizeLine "0b1100'0011'1111'0000"
        expect(tokens[0]).toEqual value: "0b1100'0011'1111'0000", scopes: ['source.cpp', 'constant.numeric.xc']
      ...
      it "does not tokenize single quotes at the beginning or end of numbers as digit separators", ->
        ...
        expect(tokens[0]).toEqual value: "'", scopes: ['source.cpp', 'string.quoted.single.xc', 'punctuation.definition.string.begin.xc']
        expect(tokens[1]).toEqual value: "1000", scopes: ['source.cpp', 'string.quoted.single.xc']

        {tokens} = grammar.tokenizeLine "1000'"
        expect(tokens[0]).toEqual value: "1000", scopes: ['source.cpp', 'constant.numeric.xc']
        expect(tokens[1]).toEqual value: "'", scopes: ['source.cpp', 'string.quoted.single.xc', 'punctuation.definition.string.begin.xc']
    ...
    describe "comments", ->
      it "tokenizes them", ->
        ...
        expect(lines[0][2]).toEqual value: '\\', scopes: ['source.cpp', 'comment.line.double-slash.cpp', 'constant.character.escape.line-continuation.xc']
    ...
    describe "operators", ->
      it "tokenizes ternary operators with namespace resolution", ->
        ...
        expect(tokens[1]).toEqual value: '?', scopes: ['source.cpp', 'keyword.operator.ternary.xc']
        ...
        expect(tokens[5]).toEqual value: ':', scopes: ['source.cpp', 'keyword.operator.ternary.xc']
